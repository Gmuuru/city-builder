System.register(["angular2/platform/browser", "angular2/core", "./ts/classes/Parser", "./ts/classes/ProgressiveLoader", "./ts/classes/Renderer", "./ts/classes/Headquarter", "./ts/classes/RoadService", "./ts/components/BuildMenu", "./ts/components/Line"], function(exports_1) {
    ...
    var browser_1, core_1, Parser_1, ProgressiveLoader_1, Renderer_1, Headquarter_1, RoadService_1, BuildMenu_1, Line_1, Line_2;
    var mainApp;
    return {
        setters:[
            ...
            mainApp = (function () {
                ...
                mainApp = __decorate([
                    core_1.Component({
                        ...
                        directives: [Line_2.LineComponent, BuildMenu_1.BuildMenuComponent],
                        providers: [Renderer_1.Renderer, ProgressiveLoader_1.ProgressiveLoader, Headquarter_1.HQ, RoadService_1.RoadService]
                    }), 
